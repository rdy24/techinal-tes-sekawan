                    ...
                    <form action="{{ route('dashboard.orders.update', $order->id) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select name="vehicle_id" class="form-control select2">
                                ...
                                <option value="{{ $vehicle->id }}" {{ old('vehicle_id', $order->
                        ...
                        <div class="form-group">
                            ...
                            <select name="driver_id" class="form-control select2">
                                ...
                                <option value="{{ $driver->id }}" {{ old('driver_id', $order->driver_id)==$driver->id ?
                                    'selected' : ''
                                    }}>
                                    {{ $driver->name }}
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="mine_id" class="form-control select2">
                                ...
                                <option value="{{ $mine->id }}" {{ old('mine_id', $order->mine_id)==$mine->id ?
                                    'selected' : ''
                                    }}>
                                    {{ $mine->name }}
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="approver_1" class="form-control select2">
                                ...
                                <option value="{{ $item->id }}" {{ old('approver_1', $order->approver_1)==$item->id ?
                                    'selected' : ''
                                    }}>
                                    {{ $item->name }}
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="approver_2" class="form-control select2">
                                ...
                                <option value="{{ $item->id }}" {{ old('approver_2', $order->approver_2)==$item->id ?
                                    'selected' : ''
                                    }}>
                                    {{ $item->name }}
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" id="start_date" name="start_date"
                                required value="{{ old('start_date', $order->start_date) }}">
                            @error('start_date')
                            <p class="text-danger">
                                {{ $message }}
                            </p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" id="return_date" name="return_date"
                                required value="{{ old('return_date', $order->return_date) }}">
                            @error('return_date')
                            <p class="text-danger">
                                {{ $message }}
                            </p>
