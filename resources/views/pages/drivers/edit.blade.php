...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active">Edit Driver</div>
    </div>
</div>
                    ...
                    <form action="{{ route('dashboard.drivers.update', $driver->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email" required
                                value="{{ old('email', $driver->email) }}" oninput="validateEmail(this)" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="status" id="status1"
                                    value="unavailable" {{ old('status', $driver->status)=='unavailable' ? 'checked' :
                                '' }}>
