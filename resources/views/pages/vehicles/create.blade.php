...
@section('title')
Tambah Kendaraan | {{ config('app.name') }}
@endsection
...
<div class="section-header">
    ...
    <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item active">Tambah Kendaraan</div>
    </div>
</div>
                    ...
                    <form action="{{ route('dashboard.vehicles.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ownership" id="ownership" value="own"
                                    {{ old('ownership')=='Milik Perusahaan' ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="ownership" id="ownership1"
                                    value="rent" {{ old('ownership')=='Sewa Perusahaan Persewaan' ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="load_type" id="load_type"
                                    value="person" {{ old('load_type')=='Orang' ? 'checked' : '' }}>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="load_type" id="load_type1"
                                    value="item" {{ old('load_type')=='Barang' ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="fuel_capacity" name="fuel_capacity" required
                                value="{{ old('fuel_capacity') }}" required>
                            @error('fuel_capacity')
                            <p class="text-danger">
                                {{ $message }}
                            </p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datepicker" id="service_schedule"
                                name="service_schedule" required value="{{ old('service_schedule') }}">
